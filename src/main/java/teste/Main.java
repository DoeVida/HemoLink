...
public class Main {
	...
	public static void main(String[] args) {
		...
		Armazenamento armazenamento= new Armazenamento(LocalDate.now());
...
//		
//		armazenamento.setEstoqueSangue(estoqueSangue);
...
//			System.out.println(hemocentro.getArmazenamento().getId());
