...
public class PaginaInicialServlet extends HttpServlet {
    ...
    private void telaInicio(HttpServletRequest request, HttpServletResponse response) throws ServletException, ServletException, IOException {
        ...
        if (campanhas != null && !campanhas.isEmpty()) {
            ...
            campanhas.clear();
            campanhas = List.of(campanha1, campanha2);
