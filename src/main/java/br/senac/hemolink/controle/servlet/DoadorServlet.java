...
public class DoadorServlet extends HttpServlet {
    ...
    private void mostrarFormularioNovoDoador(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private void inserirDoador(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException {
        ...
        Doador doador = new Doador(apelido, nome, null, senha, papel, contato, cpf, sexo, dataDeNascimento, tipoSanguineo);
