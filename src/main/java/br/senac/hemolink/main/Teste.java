...
public class Teste {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * UsuarioDAO usuarioDAO = new UsuarioDAOImpl(); Doador usuario = new Doador();
		 * 
		 * usuario.setApelido("Marii");
		 * usuario.setEmail("antoniorochadasilvaa@gmail.com"); usuario.setContato(null);
		 * usuario.setCpf("09495049478");
		 * usuario.setDataDeNascimento(LocalDate.parse("1212-12-12"));
		 * usuario.setFoto(null); usuario.setNome("mariana"); usuario.setSenha("123");
		 * usuario.setSexo('f'); usuario.setTipoSanguineo(TipoSanguineo.O_NEGATIVO);
		 ...
		 * // Long id = 1L;
		 * 
		 * // usuario.setId(id); // usuarioDAO.atualizarUsuario(usuario);
		 * 
