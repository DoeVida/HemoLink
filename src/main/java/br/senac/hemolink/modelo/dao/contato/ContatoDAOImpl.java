...
import br.senac.hemolink.modelo.entidade.contato.Contato_;
...
public class ContatoDAOImpl implements ContatoDAO {
	...
	public Contato recuperarContatoUsuario(Usuario usuario) {
		...
		try {
			...
			ParameterExpression<String> nicknameUsuario = construtor.parameter(String.class);
			criteria.where(construtor.equal(juncaoUsuario.get(Usuario_.nickname), nicknameUsuario));

			contato = sessao.createQuery(criteria).setParameter(nicknameUsuario, usuario.getNickname()).getSingleResult();
